...
export const BUILDING_DATA: Record<BuildingType, BuildingInfo> = {
  ...
  [BuildingType.JUMP_GATE]: {
    ...
    cost: (_: any) => ({ metal: 2000000, crystal: 4000000, deuterium: 2000000, energy: 0 }),
    buildTime: (_: any) => 9999999,
    energyConsumption: (_: any) => 0,
...
export const RESEARCH_DATA: Record<ResearchType, BaseGameObjectInfo & {icon: string}> = {
    ...
    [ResearchType.GRAVITON_TECHNOLOGY]: {
        ...
        icon: "⚫",
        cost: (_: any) => ({ metal: 0, crystal: 0, deuterium: 0, energy: 0 }), // Requires energy, handled separately
        buildTime: (_: any) => 1,
...
export const SHIPYARD_DATA: Record<Exclude<ShipType, ShipType.SHADOW_CORSAIR>, ShipInfo> = {
    [ShipType.LIGHT_FIGHTER]: {
        ...
        icon: "🛰️",
        image: "mlekki.jpg",
        cost: (_: any) => ({ metal: 3000, crystal: 1000, deuterium: 0, energy: 0 }),
        buildTime: (_: any) => Math.floor((3000 + 1000) / 2500 * 360),
    ...
    [ShipType.MEDIUM_FIGHTER]: {
        ...
        icon: "✈️",
        image: "msredni.jpg",
        cost: (_: any) => ({ metal: 6000, crystal: 4000, deuterium: 0, energy: 0 }),
        buildTime: (_: any) => Math.floor((6000 + 4000) / 2500 * 360),
    ...
    [ShipType.HEAVY_FIGHTER]: {
        ...
        icon: "🛸",
        image: "mciezki.jpg",
        cost: (_: any) => ({ metal: 20000, crystal: 7000, deuterium: 2000, energy: 0 }),
        buildTime: (_: any) => Math.floor((20000 + 7000 + 2000) / 2500 * 360),
    ...
    [ShipType.CARGO_SHIP]: {
        ...
        icon: "🚚",
        image: "mtrafo.jpg",
        cost: (_: any) => ({ metal: 2000, crystal: 2000, deuterium: 0, energy: 0 }),
        buildTime: (_: any) => Math.floor((2000 + 2000) / 2500 * 360),
    ...
    [ShipType.MEDIUM_CARGO_SHIP]: {
        ...
        icon: "🚛",
        image: "tsredni.jpg",
        cost: (_: any) => ({ metal: 6000, crystal: 6000, deuterium: 0, energy: 0 }),
        buildTime: (_: any) => Math.floor((6000 + 6000) / 2500 * 360),
    ...
    [ShipType.HEAVY_CARGO_SHIP]: {
        ...
        icon: "🛳️",
        image: "tduzy.jpg",
        cost: (_: any) => ({ metal: 20000, crystal: 20000, deuterium: 5000, energy: 0 }),
        buildTime: (_: any) => Math.floor((20000 + 20000 + 5000) / 2500 * 360),
    ...
    [ShipType.SPY_PROBE]: {
        ...
        icon: "📡",
        cost: (_: any) => ({ metal: 0, crystal: 1000, deuterium: 0, energy: 0 }),
        buildTime: (_: any) => Math.floor(1000 / 2500 * 360),
    ...
    [ShipType.RECYCLER]: {
        ...
        icon: "🗑️",
        cost: (_: any) => ({ metal: 10000, crystal: 6000, deuterium: 2000, energy: 0 }),
        buildTime: (_: any) => Math.floor((10000 + 6000 + 2000) / 2500 * 360),
    ...
    [ShipType.SOLAR_SATELLITE]: {
        ...
        icon: "🛰️",
        image: "satelita.jpg",
        cost: (_: any) => ({ metal: 500, crystal: 1500, deuterium: 0, energy: 0 }),
        buildTime: (_: any) => Math.floor((500 + 1500) / 2500 * 360),
    ...
    [ShipType.CRUISER]: {
        ...
        icon: "⛨",
        cost: (_: any) => ({ metal: 25000, crystal: 15000, deuterium: 5000, energy: 0 }),
        buildTime: (_: any) => Math.floor((25000 + 15000 + 5000) / 2500 * 360),
    ...
    [ShipType.BATTLESHIP]: {
        ...
        icon: "🛡️",
        cost: (_: any) => ({ metal: 45000, crystal: 15000, deuterium: 10000, energy: 0 }),
        buildTime: (_: any) => Math.floor((45000 + 15000 + 10000) / 2500 * 360),
    ...
    [ShipType.DESTROYER]: {
        ...
        icon: "🗡️",
        cost: (_: any) => ({ metal: 60000, crystal: 50000, deuterium: 15000, energy: 0 }),
        buildTime: (_: any) => Math.floor((60000 + 50000 + 15000) / 2500 * 360),
    ...
    [ShipType.BOMBER]: {
        ...
        icon: "💣",
        cost: (_: any) => ({ metal: 50000, crystal: 25000, deuterium: 15000, energy: 0 }),
        buildTime: (_: any) => Math.floor((50000 + 25000 + 15000) / 2500 * 360),
    ...
    [ShipType.COLONY_SHIP]: {
        ...
        icon: "🌍",
        cost: (_: any) => ({ metal: 10000, crystal: 20000, deuterium: 10000, energy: 0 }),
        buildTime: (_: any) => Math.floor((10000 + 20000 + 10000) / 2500 * 360),
    ...
    [ShipType.RESEARCH_VESSEL]: {
        ...
        icon: "🧭",
        cost: (_: any) => ({ metal: 8000, crystal: 12000, deuterium: 4000, energy: 0 }),
        buildTime: (_: any) => Math.floor((8000 + 12000 + 4000) / 2500 * 360),
    ...
    [ShipType.BATTLECRUISER]: {
        ...
        icon: "⛫",
        cost: (_: any) => ({ metal: 70000, crystal: 40000, deuterium: 20000, energy: 0 }),
        buildTime: (_: any) => Math.floor((70000 + 40000 + 20000) / 2500 * 360),
    ...
    [ShipType.DEATHSTAR]: {
        ...
        icon: "💀",
        cost: (_: any) => ({ metal: 5000000, crystal: 4000000, deuterium: 1000000, energy: 0 }),
        buildTime: (_: any) => Math.floor((5000000 + 4000000 + 1000000) / 2500 * 360),
...
const PROTOTYPE_SHIP_DATA: Record<ShipType.SHADOW_CORSAIR, ShipInfo> = {
    [ShipType.SHADOW_CORSAIR]: {
        ...
        icon: "👻",
        cost: (_: any) => ({ metal: 0, crystal: 0, deuterium: 0, energy: 0 }), // Not buildable
        buildTime: (_: any) => 999999, // Not buildable
        attack: 350,
        shield: 200,
...
export const DEFENSE_DATA: Record<DefenseType, DefenseInfo> = {
    [DefenseType.ROCKET_LAUNCHER]: {
        ...
        icon: "🎯",
        cost: (_: any) => ({ metal: 2000, crystal: 0, deuterium: 0, energy: 0 }),
        buildTime: (_: any) => Math.floor(2000 / 2500 * 360),
        requirements: { [BuildingType.SHIPYARD]: 1 },
        attack: 80,
        shield: 20,
        structuralIntegrity: 2000,
    ...
    [DefenseType.LIGHT_LASER_CANNON]: {
        ...
        icon: "🔫",
        cost: (_: any) => ({ metal: 1500, crystal: 500, deuterium: 0, energy: 0 }),
        buildTime: (_: any) => Math.floor((1500 + 500) / 2500 * 360),
    ...
    [DefenseType.HEAVY_LASER_CANNON]: {
        ...
        icon: "💥",
        cost: (_: any) => ({ metal: 6000, crystal: 2000, deuterium: 0, energy: 0 }),
        buildTime: (_: any) => Math.floor((6000 + 2000) / 2500 * 360),
    ...
    [DefenseType.ION_CANNON]: {
        ...
        icon: "💠",
        cost: (_: any) => ({ metal: 2000, crystal: 6000, deuterium: 0, energy: 0 }),
        buildTime: (_: any) => Math.floor((2000 + 6000) / 2500 * 360),
    ...
    [DefenseType.PLASMA_TURRET]: {
        ...
        icon: "🔮",
        cost: (_: any) => ({ metal: 20000, crystal: 15000, deuterium: 5000, energy: 0 }),
        buildTime: (_: any) => Math.floor((20000 + 15000 + 5000) / 2500 * 360),
...
export const getInitialPlayerState = (username: string, homeCoords: string): PlayerState => ({
  ...
  scopedSolarFlareState: INITIAL_SOLAR_FLARE_STATE,
  scopedContrabandState: INITIAL_CONTRABAND_STATE,
  scopedGhostShipState: INITIAL_GHOST_SHIP_STATE,
  scopedGalacticGoldRushState: INITIAL_GALACTIC_GOLD_RUSH_STATE,
  scopedStellarAuroraState: INITIAL_STELLAR_AURORA_STATE,
  scopedAncientArtifactState: INITIAL_ANCIENT_ARTIFACT_STATE,
  scopedSpacePlagueState: INITIAL_SPACE_PLAGUE_STATE,
});