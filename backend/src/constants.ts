...
export const RESEARCH_DATA: Record<ResearchType, BaseGameObjectInfo & {icon: string}> = {
    ...
    [ResearchType.GRAVITON_TECHNOLOGY]: {
        ...
        icon: "⚫",
        cost: level => ({ metal: 0, crystal: 0, deuterium: 0, energy: 0 }), // Requires energy, handled separately
        buildTime: _ => 1,
...
export const SHIPYARD_DATA: Record<Exclude<ShipType, ShipType.SHADOW_CORSAIR>, ShipInfo> = {
    [ShipType.LIGHT_FIGHTER]: {
        ...
        icon: "🛰️",
        image: "mlekki.jpg",
        cost: (_) => ({ metal: 3000, crystal: 1000, deuterium: 0, energy: 0 }),
        buildTime: (_) => Math.floor((3000 + 1000) / 2500 * 360),
    ...
    [ShipType.MEDIUM_FIGHTER]: {
        ...
        icon: "✈️",
        image: "msredni.jpg",
        cost: (_) => ({ metal: 6000, crystal: 4000, deuterium: 0, energy: 0 }),
        buildTime: (_) => Math.floor((6000 + 4000) / 2500 * 360),
    ...
    [ShipType.HEAVY_FIGHTER]: {
        ...
        icon: "🛸",
        image: "mciezki.jpg",
        cost: (_) => ({ metal: 20000, crystal: 7000, deuterium: 2000, energy: 0 }),
        buildTime: (_) => Math.floor((20000 + 7000 + 2000) / 2500 * 360),
    ...
    [ShipType.CARGO_SHIP]: {
        ...
        icon: "🚚",
        image: "mtrafo.jpg",
        cost: (_) => ({ metal: 2000, crystal: 2000, deuterium: 0, energy: 0 }),
        buildTime: (_) => Math.floor((2000 + 2000) / 2500 * 360),
    ...
    [ShipType.MEDIUM_CARGO_SHIP]: {
        ...
        icon: "🚛",
        image: "tsredni.jpg",
        cost: (_) => ({ metal: 6000, crystal: 6000, deuterium: 0, energy: 0 }),
        buildTime: (_) => Math.floor((6000 + 6000) / 2500 * 360),
    ...
    [ShipType.HEAVY_CARGO_SHIP]: {
        ...
        icon: "🛳️",
        image: "tduzy.jpg",
        cost: (_) => ({ metal: 20000, crystal: 20000, deuterium: 5000, energy: 0 }),
        buildTime: (_) => Math.floor((20000 + 20000 + 5000) / 2500 * 360),
    ...
    [ShipType.SPY_PROBE]: {
        ...
        icon: "📡",
        cost: (_) => ({ metal: 0, crystal: 1000, deuterium: 0, energy: 0 }),
        buildTime: (_) => Math.floor(1000 / 2500 * 360),
    ...
    [ShipType.RECYCLER]: {
        ...
        icon: "🗑️",
        cost: (_) => ({ metal: 10000, crystal: 6000, deuterium: 2000, energy: 0 }),
        buildTime: (_) => Math.floor((10000 + 6000 + 2000) / 2500 * 360),
    ...
    [ShipType.SOLAR_SATELLITE]: {
        ...
        icon: "🛰️",
        image: "satelita.jpg",
        cost: (_) => ({ metal: 500, crystal: 1500, deuterium: 0, energy: 0 }),
        buildTime: (_) => Math.floor((500 + 1500) / 2500 * 360),
    ...
    [ShipType.CRUISER]: {
        ...
        icon: "⛨",
        cost: (_) => ({ metal: 25000, crystal: 15000, deuterium: 5000, energy: 0 }),
        buildTime: (_) => Math.floor((25000 + 15000 + 5000) / 2500 * 360),
    ...
    [ShipType.BATTLESHIP]: {
        ...
        icon: "🛡️",
        cost: (_) => ({ metal: 45000, crystal: 15000, deuterium: 10000, energy: 0 }),
        buildTime: (_) => Math.floor((45000 + 15000 + 10000) / 2500 * 360),
    ...
    [ShipType.DESTROYER]: {
        ...
        icon: "🗡️",
        cost: (_) => ({ metal: 60000, crystal: 50000, deuterium: 15000, energy: 0 }),
        buildTime: (_) => Math.floor((60000 + 50000 + 15000) / 2500 * 360),
    ...
    [ShipType.BOMBER]: {
        ...
        icon: "💣",
        cost: (_) => ({ metal: 50000, crystal: 25000, deuterium: 15000, energy: 0 }),
        buildTime: (_) => Math.floor((50000 + 25000 + 15000) / 2500 * 360),
    ...
    [ShipType.COLONY_SHIP]: {
        ...
        icon: "🌍",
        cost: (_) => ({ metal: 10000, crystal: 20000, deuterium: 10000, energy: 0 }),
        buildTime: (_) => Math.floor((10000 + 20000 + 10000) / 2500 * 360),
    ...
    [ShipType.RESEARCH_VESSEL]: {
        ...
        icon: "🧭",
        cost: (_) => ({ metal: 8000, crystal: 12000, deuterium: 4000, energy: 0 }),
        buildTime: (_) => Math.floor((8000 + 12000 + 4000) / 2500 * 360),
    ...
    [ShipType.BATTLECRUISER]: {
        ...
        icon: "⛫",
        cost: (_) => ({ metal: 70000, crystal: 40000, deuterium: 20000, energy: 0 }),
        buildTime: (_) => Math.floor((70000 + 40000 + 20000) / 2500 * 360),
    ...
    [ShipType.DEATHSTAR]: {
        ...
        icon: "💀",
        cost: (_) => ({ metal: 5000000, crystal: 4000000, deuterium: 1000000, energy: 0 }),
        buildTime: (_) => Math.floor((5000000 + 4000000 + 1000000) / 2500 * 360),
...
const PROTOTYPE_SHIP_DATA: Record<ShipType.SHADOW_CORSAIR, ShipInfo> = {
    [ShipType.SHADOW_CORSAIR]: {
        ...
        icon: "👻",
        cost: (_) => ({ metal: 0, crystal: 0, deuterium: 0, energy: 0 }), // Not buildable
        buildTime: (_) => 999999, // Not buildable
        attack: 350,
        shield: 200,
...
export const DEFENSE_DATA: Record<DefenseType, DefenseInfo> = {
    [DefenseType.ROCKET_LAUNCHER]: {
        ...
        icon: "🎯",
        cost: (_) => ({ metal: 2000, crystal: 0, deuterium: 0, energy: 0 }),
        buildTime: (_) => Math.floor(2000 / 2500 * 360),
        requirements: { [BuildingType.SHIPYARD]: 1 },
        attack: 80,
        shield: 20,
        structuralIntegrity: 2000,
    ...
    [DefenseType.LIGHT_LASER_CANNON]: {
        ...
        icon: "🔫",
        cost: (_) => ({ metal: 1500, crystal: 500, deuterium: 0, energy: 0 }),
        buildTime: (_) => Math.floor((1500 + 500) / 2500 * 360),
    ...
    [DefenseType.HEAVY_LASER_CANNON]: {
        ...
        icon: "💥",
        cost: (_) => ({ metal: 6000, crystal: 2000, deuterium: 0, energy: 0 }),
        buildTime: (_) => Math.floor((6000 + 2000) / 2500 * 360),
    ...
    [DefenseType.ION_CANNON]: {
        ...
        icon: "💠",
        cost: (_) => ({ metal: 2000, crystal: 6000, deuterium: 0, energy: 0 }),
        buildTime: (_) => Math.floor((2000 + 6000) / 2500 * 360),
    ...
    [DefenseType.PLASMA_TURRET]: {
        ...
        icon: "🔮",
        cost: (_) => ({ metal: 20000, crystal: 15000, deuterium: 5000, energy: 0 }),
        buildTime: (_) => Math.floor((20000 + 15000 + 5000) / 2500 * 360),
