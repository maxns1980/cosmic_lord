...
import { PlayerState, BuildingType, ResearchType, ShipType, DefenseType, Resources } from '../src/types.js';
import { BUILDING_DATA, RESEARCH_DATA, ALL_SHIP_DATA, DEFENSE_DATA } from '../src/constants.js';
